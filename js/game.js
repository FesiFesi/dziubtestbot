...
if (gameState.locations.configs.park) {
    ...
    gameState.locations.configs.park.birdCosts = {
        common: 2,
        rare: 5,
        epic: 10,
        legendary: 50,
    ...
    gameState.locations.configs.park.birdTimes = {
        common: 30,
        rare: 60,
        epic: 120,
        legendary: 600,
    ...
    console.log("Skorygowano konfigurację dla Parku Miejskiego");
}
...
if (gameState.locations.configs.lake) {
    ...
    gameState.locations.configs.lake.birdCosts = {
        common: 10,
        rare: 25,
        epic: 50,
        legendary: 150,
    ...
    gameState.locations.configs.lake.birdTimes = {
        common: 60,
        rare: 300,
        epic: 600,
        legendary: 900,
    ...
    console.log("Skorygowano konfigurację dla Brzegu Jeziora");
}
...
if (gameState.locations.configs.forest) {
    ...
    gameState.locations.configs.forest.birdCosts = {
        common: 15,
        rare: 35,
        epic: 75,
        legendary: 250,
    ...
    gameState.locations.configs.forest.birdTimes = {
        common: 180,
        rare: 450,
        epic: 900,
        legendary: 1800,
    ...
    console.log("Skorygowano konfigurację dla Tajemniczego Lasu");
}
    ...
    if (slot.isActive && slot.isFeeding) {
        if (slot.feedEndTime) {
            // Używaj feedEndTime do dokładnego obliczenia
