...
window.claimMissionReward = function(missionIndex) {
    ...
    if (mission.completed && mission.rewarded !== true) {
        ...
        showNotification(`Odebrano nagrodę za misję!`);
        ...
        if (button) {
            ...
            showRewardAnimation(`+${mission.reward} DziubCoinów`, button);
        }
...
function showRewardAnimation(text, element) {
    ...
    if (parts) {
        ...
        if (type === '💰' || type.includes('DziubCoin') || type.includes('monet')) {
            // DziubCoiny
            iconHtml = `<img src="assets/images/coin-icon.png" class="coin-icon" alt="DziubCoin">`;
        } else if (type.includes('ziarenko') || type.includes('ziarenek')) {
            // Ziarenka
            iconHtml = `<img src="assets/images/seed-icon.png" class="coin-icon" alt="Ziarenko">`;
        } else if (type.includes('owoc') || type.includes('owoców')) {
            // Owoce
            iconHtml = `<img src="assets/images/fruit-icon.png" class="coin-icon" alt="Owoc">`;
        } else if (type.includes('TON')) {
            // TON
            iconHtml = `<img src="assets/images/ton-icon.png" class="coin-icon" alt="TON">`;
        } else {
...
window.claimWeeklyMissionReward = function(missionIndex) {
    ...
    if (mission.completed && mission.rewarded !== true) {
        ...
        // Powiadom gracza
        showNotification(`Odebrano nagrodę za misję tygodniową!`);
