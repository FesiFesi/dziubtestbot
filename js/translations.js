...
const translations = {
    pl: {
        ...
        general: {
            ...
            notEnoughCoins: "Nie masz wystarczająco BirdCoinów (potrzeba: {{amount}})",
            confirm: "Potwierdź"
        },
        menu: {
            mainTitle: "FEED & FLAP"
        ...
        birdSlots: {
            ...
            unlock: "Odblokuj",
            lockInfo: "Odblokuj za {{amount}} BirdCoinów",
        ...
        locations: {
            ...
            unlockFor: "Odblokuj za {{amount}} BirdCoinów",
            unlockInfo: "Odblokuj tę lokację za {{amount}} BirdCoinów w menu Mapy!",
            description: {
        ...
        notEnoughCoins: "Za mało BirdCoinów! Potrzebujesz {{amount}} monet.",


          receivedTon: "Otrzymałeś {{amount}} TON za mitycznego ptaka!",
    receivedCoinsWithBonus: "Otrzymałeś {{baseAmount}} + {{bonusAmount}} BirdCoinów (bonus z fontanny)!",
    receivedCoins: "Otrzymałeś {{amount}} BirdCoinów!",
    ...
    lakeGridNotFound: "Siatka ptaków jeziora nie znaleziona - uruchamiam naprawę"
        ...
        shop: {
            ...
            decorations: {
                ...
                fountainDesc: "Piękna fontanna przyciągająca BirdCoiny",
                fountainBonus: "Bonus: +10% więcej BirdCoinów",
                ...
                kiteBonus: "Bonus: +12% więcej BirdCoinów",
                ...
                mushroomsDesc: "Tajemnicze grzyby rosnące w lesie przyciągają ptaki swoim zapachem",
                mushroomsBonus: "Bonus: -14% koszt karmienia ptaków",
                squirrelName: "Przyjazna wiewiórka",
                squirrelDesc: "Wesoła wiewiórka, która dzieli się swoimi zapasami z ptakami",
                squirrelBonus: "Bonus: +14% więcej BirdCoinów",
                deerName: "Majestatyczny jeleń",
                deerDesc: "Dostojny jeleń, który swoją obecnością uspokaja ptaki",
...
buttons: {
    ...
    notifications: {
        ...
        rewardBonus: " Teraz otrzymujesz o {{value}}% więcej BirdCoinów!",
        ...
        production: {
            ...
            upgrades: "Ulepszenia",
            biggerCapacity: "Większy Auto Zbieracz",
            ...
            upgradeButton: "Ulepsz ({{amount}} BirdCoinów)",
            autoCapacityIncreased: "Zwiększono pojemność Auto Zbioru!",
            autoSpeedIncreased: "Zwiększono szybkość Auto Zbioru!"
        },
        missions: {
            title: "Misje",
            ...
            rewardLabel: "Nagroda: {{reward}} BirdCoinów",
            claim: "Odbierz",
            ...
            weekly: {
                ...
                feedEpicBirds: {
                   ...
                   feedLegendaryBirds: {
            title: "Nakarm {{amount}} legendarnych ptaków",
            description: "Znajdź i nakarm {{amount}} legendarnych ptaków"
        },
                collectCurrency: {
                    title: "Zbierz {{amount}} BirdCoinów",
                    description: "Zbierz w sumie {{amount}} BirdCoinów"
                },
          completeDailyMissions: {
            title: "Wykonaj 15 dziennych misji",
            description: "Ukończ 15 dziennych misji w ciągu tygodnia"
        }
            }
        },
        feeding: {
...
renameBird: "Zmień imię ptaka",
renameCostText: "Koszt:",
enterNewName: "Wpisz nowe imię",
noBirdToRename: "Nie masz ptaka, któremu możesz zmienić imię",
nameEmpty: "Imię nie może być puste",
nameTooLong: "Imię jest za długie (max 18 znaków)",
notEnoughCoinsForRename: "Nie masz wystarczającej liczby monet",
sameNameError: "To imię jest takie samo jak obecne",
nameChanged: "Imię zmienione!",
 ...
 birdStatus: {
  ...
  birdEvents: {
        ...
        adultReward: "Otrzymujesz 100 BirdCoinów za wychowanie dorosłego ptaka!"
    },
...
activeExpedition: {
    ...
    skinUnavailable: "Niedostępny"
        ...
        wallet: {
            ...
            mythicalBirdsDesc: "W każdej lokacji masz szansę natrafić na mitycznego ptaka. Po jego nakarmieniu otrzymasz nagrodę TON. Potrzebujesz tylko owoców i szczęścia",
            expeditions: "Ekspedycje",
            expeditionsDesc: "Gdy twój ptak w gnieździe dorośnie do poziomu 4, wyślij go na wyprawę pełną przygód. Może przynieść z niej cenne TON i inne nagrody",
            currencyExchange: "Wymień",
...
referral: {
    ...
    claimButton: "Odbierz",
    welcomeBonus: "Bonus za zaproszenie: +{{amount}} BirdCoinów!",
    newUserJoined: "Nowy użytkownik dołączył! +{{amount}} BirdCoinów!",
    linkCopied: "Link skopiowany!",
    copyError: "Błąd kopiowania",
    alreadyClaimed: "Ta nagroda została już odebrana!",
    notEnoughInvites: "Potrzebujesz {{amount}} zaproszeń!",
    rewardClaimed: "Odebrano nagrodę za {{tier}} zaproszeń!",
    invitation: "zaproszenie",
    invitations: "zaproszeń",
    remaining: "Pozostało:",
    birdCoins: "BirdCoinów",
    fruits: "owoców",
    rewardDescription: "{{coins}} BirdCoinów{{fruits}}{{ton}}{{special}}"
},
...
logs: {
 ...
 logs: {
    ...
    ui: {
        rewards: "Nagrody",
        unlockCost: "Odblokuj za {{amount}} BirdCoinów",
...
gameEnd: "Koniec gry!"
    ...
    skinUnavailable: "Niedostępny"
        ...
        notifications: {
            minCoinsAmount: "Minimalna kwota to 100 BirdCoinów!",
            notEnoughCoins: "Nie masz wystarczająco BirdCoinów!",
            enterFruitsAmount: "Podaj liczbę owoców do wymiany!",
            notEnoughFruits: "Nie masz wystarczająco owoców!",
            convertedCoinsToFruits: "Wymieniono {{amount}} BirdCoinów na {{fruits}} owoców!",
            convertedFruitsToCoins: "Wymieniono {{amount}} owoców na {{coins}} BirdCoinów!",
                receivedFruitsForCoins: "Otrzymałeś {{fruits}} owoców za {{coins}} BirdCoinów",
            gameReset: "Gra została zresetowana!",
            confirmReset: "Czy na pewno chcesz zresetować grę?",
            ...
            levelUp: "Osiągnięto poziom {{level}}! +{{amount}} BirdCoinów!",
            ...
            rewardsCollected: "Odebrano nagrody od {{count}} ptaków: +{{coins}} BirdCoinów!",
        ...
        telegram: {
            ...
            achievementShare: "Zdobyłem osiągnięcie \"{{achievementTitle}}\" w grze BirdCoins! Zagraj ze mną!",
...
sound: {
    ...
    notifications: {
        ...
        noBirdsToFeed: "Brak ptaków do nakarmienia w lokacji {{location}}!",
        rewardsWithTon: "Odebrano nagrody od {{birds}} ptaków w lokacji {{location}}: +{{coins}} BirdCoinów i +{{ton}} TON!",
              successfulFeedingFallback: "Pomyślnie nakarmiono ptaki!",
        noFeedingFallback: "Brak ptaków do nakarmienia!"
    },
    buttons: {
        feedAll: "Nakarm wszystkie",
        collectAll: "Odbierz wszystkie"
...
function t(path, values = {}) {
    // NAPRAWIONE: Pobierz aktualny język bezpośrednio z localStorage
    const actualLanguage = localStorage.getItem('gameLanguage') || 
                           (window.gameState?.settings?.language) || 'en';
    
    // Aktualizuj currentLanguage jeśli się różni
    if (currentLanguage !== actualLanguage) {
        currentLanguage = actualLanguage;
        console.log("Zaktualizowano język w funkcji t():", currentLanguage);
    }
    
    // Sprawdź czy tłumaczenia dla języka istnieją
...
function getTranslation(lang, path, values) {
    ...
    // Sprawdź, czy końcowa wartość jest obiektem
    if (typeof value === 'object' && value !== null) {
        console.warn("Ostrzeżenie: Tłumaczenie dla klucza", path, "w języku", lang, "jest obiektem, a nie tekstem");
        return path; // Zwróć ścieżkę, zamiast obiektu
    }
...
if (typeof value === 'string' && values) {
    // Specjalna obsługa dla ilości z odmianą
    if (values.amount !== undefined && path.includes('catalog.')) {
        const amount = parseInt(values.amount);
        
        // Sprawdź czy to ścieżka wymagająca odmiany
        if (currentLanguage === 'pl') {
            if (path.includes('seeds')) {
                const forms = translations.pl.catalog.units.seeds;
                const unit = getPolishPlural(amount, [forms.one, forms.few, forms.many]);
                return `${amount} ${unit}`;
            } else if (path.includes('fruits')) {
                const forms = translations.pl.catalog.units.fruits;
                const unit = getPolishPlural(amount, [forms.one, forms.few, forms.many]);
                return `${amount} ${unit}`;
            } else if (path.includes('coins')) {
                const forms = translations.pl.catalog.units.coins;
                const unit = getPolishPlural(amount, [forms.one, forms.few, forms.many]);
                return `${amount} ${unit}`;
            }
        }
...
// Funkcja do polskiej odmiany rzeczowników
function getPolishPlural(number, forms) {
    // forms = [pojedyncza, kilka, wiele]
    // np. ["ziarenko", "ziarenka", "ziarenek"]
    if (number === 1) return forms[0];
    const lastDigit = number % 10;
    const lastTwoDigits = number % 100;
    
    if (lastTwoDigits >= 12 && lastTwoDigits <= 14) {
        return forms[2]; // ziarenek
    }
    
    if (lastDigit >= 2 && lastDigit <= 4) {
        return forms[1]; // ziarenka
    }
...
function changeLanguage(lang) {
    ...
    try {
        ...
        // Zapisz język w gameState dla trwałości
        if (window.gameState) {
        ...
        // ZMIENIONA KOLEJNOŚĆ - najpierw aktualizuj dane misji
        updateDailyMissionTexts();
        updateWeeklyMissionTexts();
        
        // Następnie aktualizuj wszystkie teksty
        updateAllTexts();
        
        // Natychmiast aktualizuj UI misji - BEZ OPÓŹNIEŃ
        ...
        // Zapisz stan gry po zmianie języka
...
// Wyzwól zdarzenie zmiany języka dla innych modułów - NOWY KOD
        const languageChangedEvent = new Event('languageChanged');
        document.dispatchEvent(languageChangedEvent);

// Aktualizuj teksty w katalogu jeśli jest otwarty
...
setTimeout(() => {
    ...
    // Wywołaj specyficzne funkcje aktualizujące
...
function updateAllMissionTexts() {
    console.log("Bezpośrednia aktualizacja tekstów misji");
    ...
    return true; // Zwróć wartość dla potwierdzenia wykonania
}
...
function updateMissionUI_Direct() {
    console.log("Bezpośrednia aktualizacja interfejsu misji");
    
    // 1. Aktualizuj nagłówki sekcji
    ...
    // 2. Aktualizuj tytuły misji dziennych bezpośrednio w DOM
    if (gameState && gameState.missions) {
        gameState.missions.forEach((mission, index) => {
            ...
            if (missionElement) {
                ...
                // Dodaj aktualizację paska postępu
    ...
    // 3. Aktualizuj tytuły i opisy misji tygodniowych bezpośrednio w DOM
...
// Funkcja aktualizująca teksty misji dziennych
function updateDailyMissionTexts() {
    console.log("Aktualizacja tekstów misji dziennych");
    ...
    // Aktualizuj każdą misję dzienną
...
// Funkcja aktualizująca teksty misji tygodniowych
function updateWeeklyMissionTexts() {
    console.log("Aktualizacja tekstów misji tygodniowych");
    ...
    // Aktualizuj każdą misję tygodniową
    gameState.weeklyMissions.forEach(mission => {
        switch(mission.type) {
            ...
            case 'feedEpicBirds':
                ...
                mission.target = epicBirdsAmount; // Aktualizuj również cel misji
                break;
            ...
            case 'completeDailyMissions':
                ...
                mission.target = 15; // Zmiana z 5 na stałą wartość 15
                break;
        }
    });
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    languageSwitchers.forEach(switcher => {
        switcher.addEventListener('click', function() {
            ...
            if (lang === 'pl' || lang === 'en') {
                ...
                // Bezpośrednio wymuś aktualizację misji
                setTimeout(() => {
                    updateDailyMissionTexts();
                    updateWeeklyMissionTexts();
                    updateMissionUI_Direct();
    ...
    if (missionsNavButton) {
        missionsNavButton.addEventListener('click', function() {
            // Natychmiastowa aktualizacja misji przy przejściu na ekran
            updateDailyMissionTexts();
            updateWeeklyMissionTexts();
            
            // Daj czas na zmianę ekranu, potem aktualizuj UI
            setTimeout(() => {
                updateMissionUI_Direct();
            }, 50);
        });
