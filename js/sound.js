...
const SoundModule = {
    ...
    fixSettingsModalLayout: function() {
        ...
        setTimeout(() => {
            ...
            console.log("Naprawiono układ okna ustawień");
        }, 500);
    },
...
initLanguageOptions: function() {
    console.log("Inicjalizacja kontrolek wyboru języka");
    ...
    languageOptions.forEach(option => {
        ...
        const lang = langText === 'pl' ? 'pl' : langText === 'en' ? 'en' : 'ua';
        ...
        newOption.addEventListener('click', () => {
            ...
            if (typeof window.changeLanguage === 'function') {
                ...
                document.querySelectorAll('.language-option').forEach(opt => {
                    ...
                    const optLang = optLangText === 'pl' ? 'pl' : optLangText === 'en' ? 'en' : 'ua';
                ...
                if (typeof showNotification === 'function') {
                    ...
                    showNotification(`Język: ${langNames[lang]}`);
                }
...
this.initLanguageOptions();
    ...
    console.log("Kontrolki wyboru języka zainicjalizowane");
}
