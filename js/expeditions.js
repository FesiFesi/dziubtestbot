...
collectRewards: function() {
    ...
    // NAPRAWIONE: Sprawdź, czy pokazać ekran przepustki nagród czy ekran hodowli
...
showRewardPassDistance: function(distance) {
    ...
    cancelExpedition: function() {
        ...
        if (confirm("Czy na pewno chcesz anulować ekspedycję? Stracisz wszystkie potencjalne nagrody i nie otrzymasz zwrotu kosztów.")) {
            ...
            // Usuń dane ekspedycji z localStorage - DODANE!
            localStorage.removeItem('activeExpedition');
...
// Obsługa przycisków nawigacji - CAŁKOWICIE PRZEROBIONA FUNKCJA
