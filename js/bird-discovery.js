    ...
    lakebirds.forEach(bird => {
        ...
        birdItem.innerHTML = `
            ...
            <div class="catalog-bird-stats">
                <div class="catalog-bird-stat">${t('catalog.birdStats.type')} ${bird.type}</div>
                <div class="catalog-bird-stat">${t('catalog.birdStats.chance')} ${bird.chance}</div>
                <div class="catalog-bird-stat">${t('catalog.birdStats.time')} ${bird.time}</div>
                <div class="catalog-bird-stat">${t('catalog.birdStats.cost')} ${bird.cost}</div>
                <div class="catalog-bird-stat">${t('catalog.birdStats.reward')} ${bird.reward}</div>
            </div>
        `;
